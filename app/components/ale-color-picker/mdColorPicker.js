...
// <img src=\"/app/components/ale-color-picker/ic_color_lens.svg\" class=\"md-color-picker-preview\"  ng-if=\"mdColorPreview\">\n	Cambiar Color	<div class=\"md-color-picker-result\" ng-style=\"{background: value}\"></div>\n	</img>\n
angular.module("mdColorPicker").run(["$templateCache", function($templateCache) {$templateCache.put("mdColorPicker.tpl.html","<div class=\"md-color-picker-input-container\" layout=\"row\" ng-click=\"showColorPicker($event)\">\n	CAMBIAR COLOR	<md-button class=\"md-icon-button md-color-picker-clear\" ng-if=\"mdColorClearButton && value\" ng-click=\"clearValue();\" aria-label=\"Clear Color\">\n		<md-icon md-svg-icon=\"clear.svg\"></md-icon>\n	</md-button>\n</div>\n");
